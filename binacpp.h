...
public:
    ...
    QByteArray trade(QString price, QString amount, QString symbol, QString side, QString type, QString window);
    ...
    QByteArray getMyTrades(QString symbol, QString limit);
    QByteArray getMyAllTrades(QString symbol, QString limit);
    QByteArray getMyAllTrades(QString symbol, QString limit, QString startTime, QString endTime);
